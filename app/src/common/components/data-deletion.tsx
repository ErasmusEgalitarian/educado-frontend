...
const DataDeletionRequest: React.FC = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <p>
        If you wish to delete specific data associated with your account on
        Educado, please contact us at{" "}
      ...
      <p>
        Upon processing your request, the specified data such as personal
        identifiable information, course subscriptions, and related progress
