...
import {
  ...
  putFormThree,
  putFormTwo,
} from "@user/api/profile-mutations";
...
const Profile = () => {
  ...
  }, [fetchDynamicData, fetchStaticData, userID]);
              ...
              <button
                ...
                className={`second_form_open w-[1000px] h-[72px] p-6 shadow-xl flex-col justify-start items-start gap-20 inline-flex font-bold pl-6 ${
                  isAcademicExperienceOpen
                    ...
                    : "rounded-lg bg-white text-neutral-700" // When closed: rounded corners, white background, gray text
                }`}
                onClick={() => {
