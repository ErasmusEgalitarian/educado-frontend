...
export default function NavigationFooter(
  props: Readonly<NavigationFooterProps>
): JSX.Element {
  ...
  const { call: verifyUser, isLoading: isVerifyingUser } =
    useApi(postUserVerification);
  const { call: loginUser, isLoading: isLoggingIn } = useApi(postUserLogin);
