 ...
 * @param {PasswordModalProps} props properties of the component:
 * - `setError`: function that sets the error message
 * - `setErrorMessage`: function that sets the error message
 * @returns {JSX.Element} the modal component
 */
const PasswordRecoveryModal = (props: PasswordModalProps): JSX.Element => {
  ...
  const { call: apiSendEmail, isLoading: isSendingEmail } = useApi(sendEmail);
  const { call: apiVerifyCode, isLoading: isVerifyingCode } =
    useApi(verifyCode);
  const { call: apiUpdatePassword, isLoading: isUpdatingPassword } =
