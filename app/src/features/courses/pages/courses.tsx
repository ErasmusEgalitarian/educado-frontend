...
import { getAllCreatorCourses } from "@courses/api/course-queries";
import CourseGuideButton from "@courses/components/course-guide";
import { CourseListCard } from "@courses/components/course-list-card";
import PersonalInsights from "@courses/components/personal-insights";
...
const Courses = () => {
  ...
  const { data, error } = useSWR(token ? [token] : null, getAllCreatorCourses);
