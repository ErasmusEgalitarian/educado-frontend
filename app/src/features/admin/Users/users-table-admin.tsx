...
export const UsersTableAdmin = () => {
  ...
  function getApprovalStatus(user: UserRecord): string {
    if (user.approved) return "Aprovado";
    if (user.rejected) return "Recusado";
